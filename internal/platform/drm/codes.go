...
var (
	...
	DRM_IOCTL_MODE_ADDFB2            = IOWR(drmIoctlBase, 0xB8, unsafe.Sizeof(FB2{}))
	...
	DRM_IOCTL_PRIME_FD_TO_HANDLE     = IOWR(drmIoctlBase, 0x2e, unsafe.Sizeof(PrimeHandle{}))
	DRM_IOCTL_PRIME_HANDLE_TO_FD     = IOWR(drmIoctlBase, 0x2d, unsafe.Sizeof(PrimeHandle{}))
)
