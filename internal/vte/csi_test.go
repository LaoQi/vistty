...
func TestCSICursorUp(t *testing.T) {
	seq := Sequence{Action: ActionCSI, Command: 'A', Params: [32]int{5}, NParams: 1}
	csi := ParseCSI(seq)
...
func TestCSICursorPosCmd(t *testing.T) {
	seq := Sequence{Action: ActionCSI, Command: 'H', Params: [32]int{10, 20}, NParams: 2}
	csi := ParseCSI(seq)
...
func TestCSIEraseInDisplay(t *testing.T) {
	seq := Sequence{Action: ActionCSI, Command: 'J', Params: [32]int{2}, NParams: 1}
	csi := ParseCSI(seq)
...
func TestCSISGR(t *testing.T) {
	seq := Sequence{Action: ActionCSI, Command: 'm', Params: [32]int{1, 31}, NParams: 2}
	csi := ParseCSI(seq)
...
func TestCSICursorHide(t *testing.T) {
	...
	csi := ParseCSI(seqs[0])
	if csi.Command != CSIResetMode {
		t.Errorf("expected CSIResetMode, got %d", csi.Command)
	}
	if !csi.Private {
		t.Error("expected Private=true")
	}
	if csi.NParams != 1 || csi.Params[0] != 25 {
		t.Errorf("expected params [25], got %v", csi.Params[:csi.NParams])
	}
}
...
func TestCSICursorShow(t *testing.T) {
	...
	csi := ParseCSI(seqs[0])
	if csi.Command != CSISetMode {
		t.Errorf("expected CSISetMode, got %d", csi.Command)
	}
	if csi.NParams != 1 || csi.Params[0] != 25 {
		t.Errorf("expected params [25], got %v", csi.Params[:csi.NParams])
	}
...
func TestCSIDeleteChars(t *testing.T) {
	seq := Sequence{Action: ActionCSI, Command: 'P', Params: [32]int{3}, NParams: 1}
	csi := ParseCSI(seq)
...
func TestCSIMargins(t *testing.T) {
	seq := Sequence{Action: ActionCSI, Command: 'r', Params: [32]int{1, 24}, NParams: 2}
	csi := ParseCSI(seq)
...
func TestCSIEraseChars(t *testing.T) {
	seq := Sequence{Action: ActionCSI, Command: 'X', Params: [32]int{3}, NParams: 1}
	csi := ParseCSI(seq)
...
func TestCSIDeviceStatusReport(t *testing.T) {
	seq := Sequence{Action: ActionCSI, Command: 'n', Params: [32]int{6}, NParams: 1}
	csi := ParseCSI(seq)
...
func TestCSIDeviceAttributes(t *testing.T) {
	seq := Sequence{Action: ActionCSI, Command: 'c', Params: [32]int{0}, NParams: 1}
	csi := ParseCSI(seq)
...
func TestCSIDECSCA(t *testing.T) {
	seq := Sequence{Action: ActionCSI, Command: 'q', Intermed: []byte{'"'}, Params: [32]int{1}, NParams: 1}
	csi := ParseCSI(seq)
...
func TestCSIBareQUnknown(t *testing.T) {
	seq := Sequence{Action: ActionCSI, Command: 'q', Params: [32]int{1}, NParams: 1}
	csi := ParseCSI(seq)
...
func TestCSITabClear(t *testing.T) {
	seq := Sequence{Action: ActionCSI, Command: 'g', Params: [32]int{3}, NParams: 1}
	csi := ParseCSI(seq)
